  ...
  return safeCandidates
    .map((candidate) => {
      ...
      return {
        ...
        context: truncateText(candidate?.domPath || candidate?.selector, 180),
        contextPath: truncateText(candidate?.domPath || candidate?.selector, 220),
        parentContext: truncateText(candidate?.parentSelector || candidate?.domPath || '', 180),
        parentSelector: truncateText(candidate?.parentSelector || '', 180),
        ...
        controls: candidate?.controls === true,
      }
    })
