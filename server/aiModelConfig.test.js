...
test('AI_QA_MODEL falls back to gpt-5.6-sol when unset or blank', () => {
  assert.equal(DEFAULT_AI_QA_MODEL, 'gpt-5.6-sol')
  assert.equal(getAiQaModel({}), 'gpt-5.6-sol')
  assert.equal(getAiQaModel({ AI_QA_MODEL: '   ' }), 'gpt-5.6-sol')
})
